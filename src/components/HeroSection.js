...
const HeroSection = () => {
    ...
    const [activeService, setActiveService] = useState('Search All');
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center space-y-12">
                        ...
                        <div className="max-w-4xl mx-auto">
                            {/* Service Options - Updated hover states */}
                                    ...
                                    <div className="relative flex-1">
                                        <div className="relative flex items-center bg-gray-50 border border-gray-200 rounded-lg focus-within:ring-2 focus-within:ring-[#155dfc] focus-within:border-[#155dfc] transition-all duration-300">
                                            <button
                                                ...
                                                className="flex items-center justify-between pl-4 pr-3 py-3 w-40 text-sm text-gray-900 font-medium border-r border-gray-200 focus:outline-none hover:bg-[#155dfc]/10 hover:text-[#155dfc] transition-colors duration-200"
                                            >
